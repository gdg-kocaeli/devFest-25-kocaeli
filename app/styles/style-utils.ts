...
export const componentStyles = {
  navigation: {
    ...
    container: "max-w-none mx-auto px-[152px]",
    navRow: "flex justify-between items-center h-16",
    logo: "flex-shrink-0",
    ...
    menuItem: (active: boolean) => `px-3 py-2 text-[14px] font-normal font-inter ${active ? 'text-blue-400' : 'text-[#E0E2E3] hover:text-blue-400'}`,
